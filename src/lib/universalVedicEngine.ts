...
const CHAPTER_THEMES: Record<number, { core: string; philosophy: string; psychology: string; science: string; meditation: string }> = {
  1: {
...
export type CommentaryDimension = "universal" | "advaita" | "vishishtadvaita" | "dvaita" | "jnaneshwari" | "vivekananda" | "science" | "meditation";
