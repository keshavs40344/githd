...
export default function GlobalRoyalFooter() {
  ...
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 border-b border-[#c5a059]/15 pb-8 text-center md:text-left">
            <div className="space-y-2">
              <div className="flex items-center justify-center md:justify-start gap-2.5">
                ...
                <span className="font-bold text-lg text-[#f5eed9] tracking-wider">
                  श्री राधा-कृष्ण महामन्दिर <span className="text-amber-400 font-mono text-xs">Dharma.OS</span>
                </span>
              </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2 rounded-2xl bg-emerald-500/15 hover:bg-emerald-500/30 border border-emerald-400/40 text-xs font-mono text-emerald-300 flex items-center gap-1.5 transition-all shadow-md cursor-pointer"
              >
                <Server className="w-3.5 h-3.5 text-emerald-400" />
                <span>🖥️ लाइव सर्वर कंट्रोल (24x7)</span>
              </button>
      ...
      {/* Global Server Modal for Footer */}
