...
export const metadata = {
  title: 'Divine Episodes of Wisdom • Bhagavad Gita Quest | Dharma.OS',
  description: 'Explore all 18 divine chapters and episodes of the Bhagavad Gita with audio flute raga tunes, deep psychological explanations, and progress tracking.',
};
...
export default function EpisodesPage() {
  return (
    <main className="min-h-screen bg-obsidian-950 text-gold-100 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-gold-600/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-amber-700/10 rounded-full blur-[140px] pointer-events-none" />
