...
import { ArrowLeft, Home, Sparkles, BookOpen, Layers, ChevronRight } from 'lucide-react';
...
export default function ShlokaDynamicPage() {
  ...
  return (
    <div className="min-h-screen bg-[#07080d] text-[#f5eed9] font-sans antialiased selection:bg-[#c5a059]/30">
      ...
      {/* ── GRAND SHLOKA SANCTUARY CONTAINER ───────────────────────────── */}
